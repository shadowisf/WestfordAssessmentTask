...
import { ArrowRightMinimal } from "./components/svg/ArrowsMinimal";
        ...
        <div className="grid grid-cols-3">
          ...
          <div className="space-y-[20px]">
            ...
            <p className="font-extralight text-[16px]">
              ...
              Management and Technology proudly collaborates with top
              institutions globally, ensuring our students receive world-class
              higher education.
            </p>
          </div>
        </div>
