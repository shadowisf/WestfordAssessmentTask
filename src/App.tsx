...
import BulletPoint from "./components/svg/BulletPoint";
      ...
      <div className="px-[42px] pt-[40px] pb-[77px] space-y-[77px]">
        ...
        <div className="flex justify-between">
          <div className="space-y-[20px]">
            ...
            <div className="p-[45px] grid grid-cols-1 justfy-between border border-[#E6E6E6] rounded-[25px] w-[679px]">
              <div className="grid grid-cols-2 pb-[20px] text-[24px]">
...
function KeyLearningsItem({ children }: { children: string }) {
  return (
    <div className="flex gap-[20px] font-light text-[16px] w-[542px]">
